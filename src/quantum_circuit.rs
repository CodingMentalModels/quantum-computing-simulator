...
mod test_quantum_circuit {
    ...
    fn test_trivial_quantum_circuit() {
        ...
        circuit.add_gate(QuantumGate::identity());
    ...
    fn test_serial_quantum_circuit() {
        ...
        assert!(circuit.run(Register::singleton(Qubit::basis_0())).almost_equals(&Register::singleton(Qubit::basis_1())));
        assert!(circuit.run(Register::singleton(Qubit::basis_1())).almost_equals(&Register::singleton(Qubit::basis_0())));
        assert!(circuit.run(Register::singleton((Qubit::mix(Qubit::basis_0(), Qubit::basis_1(), 1., 1.)))).almost_equals(&Register::singleton(Qubit::mix(Qubit::basis_1(), Qubit::basis_0(), 1., 1.))));
    }
    ...
    fn test_two_qubit_quantum_circuit() {
        ...
        assert!(circuit.run(Register::fill(Qubit::basis_0(), 2)).almost_equals(&Register::fill(Qubit::basis_0(), 2)));
        assert!(circuit.run(Register::fill(Qubit::basis_1(), 2)).almost_equals(&Register::fill(Qubit::basis_1(), 2)));
    }
